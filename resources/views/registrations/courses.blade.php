<!-- resources/views/registrations/courses.blade.php -->
        ...
        <div class="col-md-12">
            <div class="card border-0 shadow-lg my-3">
                <div class="card-header bg-dark text-center">
                    <h3 class="text-white">C Course Registrations</h3>
                </div>
                <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex flex-wrap">
                                                <a href="{{ route('registrations.edit_confirm', $admission->id) }}" class="btn btn-dark me-2 mb-2 mb-md-0">Edit</a>
                                                ...
                                                <form id="delete-admission-form-{{ $admission->id }}" action="{{ route('registrations.destroy1', $admission->id) }}" method="POST" class="mb-2 mb-md-0">
                                                    @csrf
                                                    @method('delete')
                                                    <button type="submit" class="btn btn-danger mt-2" onclick="return confirm('Are you sure you want to delete this registration?')">Delete</button>
                                                </form>
                                            </div>
                                        </td>
                                    </tr>
